            ...
            <form class="row" action="../db/db_rooms_select_availability.php" method="POST">
                <form class="row align-items-start" action="db/db_rooms_select_availability.php" method="POST">
                    <div class="mb-3 col">
                        ...
                        <input required="true" type="date" class="form-control" name="date_in" value="<?php if (isset($_SESSION["date_in"])){
                            echo $_SESSION["date_in"];
                        }?>">
                    </div>
                    <div class="mb-3 col">
                        <label for="date_out" class="form-label">Check out</label>
                        <input required="true" type="date" class="form-control" name="date_out" value="<?php if (isset($_SESSION["date_out"])){
